...
with open('/Users/lokesh/Downloads/Database_433_Project/DataProcessing/AmazonData.txt', 'r') as f:
    edges = f.readlines()
...
metadata= {}
product_data={}
with open('/Users/lokesh/Downloads/Database_433_Project/DataProcessing/amazon-meta.txt', 'r', encoding="utf8") as file:
    for _ in range(2):
        next(file)
    for line in file:
        line = line.strip()
